...
public class FutexNanoSleepWaiter extends FutexWaiter {
    ...
    public FutexNanoSleepWaiter(Pointer uaddr, int val, TimeSpec timeSpec) {
        ...
        // A sub-millisecond relative timeout truncates to 0 here; clamp to 0 so canDispatch()
        // reports an immediate timeout instead of throwing IllegalStateException.
        this.waitMillis = Math.max(0L, timeSpec.toMillis());
